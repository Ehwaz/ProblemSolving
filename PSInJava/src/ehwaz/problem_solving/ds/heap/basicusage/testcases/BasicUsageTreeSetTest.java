package ehwaz.problem_solving.ds.heap.basicusage.testcases;

import ehwaz.problem_solving.ds.heap.basicusage.BasicUsage;
...
public class BasicUsageTreeSetTest {

    ///////////// Test-specific codes: you only need to modify these lines. /////////////////
    Consumer<InputStream> SOLUTION_TO_TEST = istream -> BasicUsage.runUsingTreeSet(istream);    // Requires Java 8
    private final int numOfTestCases = 2;
    private final String[] INPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/ds/heap/basicusage/testcases/input11.txt",
            "src/ehwaz/problem_solving/ds/heap/basicusage/testcases/input15.txt"
    };
    private final String[] OUTPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/ds/heap/basicusage/testcases/output11.txt",
            "src/ehwaz/problem_solving/ds/heap/basicusage/testcases/output15.txt"
    };
