...
public class CheckBalancingTest {
    ...
    private final String INPUT_FILE_PATH = "src/ehwaz/problem_solving/ds/stack/balancingparen/input17.txt";
    private final String OUTPUT_FILE_PATH = "src/ehwaz/problem_solving/ds/stack/balancingparen/output17.txt";
    ...
    public void testSolveProb() throws Exception {
        ...
        CheckBalancing.runProb(istream);
