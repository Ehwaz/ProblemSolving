package ehwaz.problem_solving.algorithm.implementation.larrys_array.testcases;

import ehwaz.problem_solving.algorithm.implementation.larrys_array.LarrysArray;
...
public class LarrysArrayTest {
    ...
    Consumer<InputStream> SOLUTION_TO_TEST = istream -> LarrysArray.runSolution(istream);    // Requires Java 8
    private final int numOfTestCases = 2;
    private final String[] INPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/algorithm/implementation/larrys_array/testcases/input00.txt",
            "src/ehwaz/problem_solving/algorithm/implementation/larrys_array/testcases/input12.txt"
    };
    private final String[] OUTPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/algorithm/implementation/larrys_array/testcases/output00.txt",
            "src/ehwaz/problem_solving/algorithm/implementation/larrys_array/testcases/output12.txt"
    };
