package ehwaz.problem_solving.algorithm.greedy.maxsubarrray.testcases;

import ehwaz.problem_solving.algorithm.greedy.maxsubarrray.MaxSubArray;
...
public class MaxSubArrayTest {
    ...
    Consumer<InputStream> SOLUTION_TO_TEST = istream -> MaxSubArray.runSolution(istream);    // Requires Java 8
    private final int numOfTestCases = 1;
    private final String[] INPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/algorithm/greedy/maxsubarrray/testcases/input1.txt",
    };
    private final String[] OUTPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/algorithm/greedy/maxsubarrray/testcases/output1.txt",
    };
