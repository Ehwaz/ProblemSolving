...
public class CountingSortProbTest {
    ...
    private final String INPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/sorting/countingsort/input05.txt";
    private final String OUTPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/sorting/countingsort/output05.txt";
    ...
    public void testSolveProb() throws Exception {
        ...
        CountingSortProb.solveProb2(istream);
