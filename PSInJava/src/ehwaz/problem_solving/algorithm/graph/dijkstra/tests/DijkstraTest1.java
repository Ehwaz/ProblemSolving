...
public class DijkstraTest1 {
    ...
    private final String INPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/graph/dijkstra/tests/input01.txt";
    private final String OUTPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/graph/dijkstra/tests/output01.txt";
