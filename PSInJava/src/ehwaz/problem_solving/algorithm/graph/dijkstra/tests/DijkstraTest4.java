...
public class DijkstraTest4 {
    ...
    private final String INPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/graph/dijkstra/tests/input04.txt";
    private final String OUTPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/graph/dijkstra/tests/output04.txt";
