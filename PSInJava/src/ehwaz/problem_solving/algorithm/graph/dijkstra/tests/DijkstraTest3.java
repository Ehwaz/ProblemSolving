...
public class DijkstraTest3 {
    ...
    private final String INPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/graph/dijkstra/tests/input03.txt";
    private final String OUTPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/graph/dijkstra/tests/output03.txt";
