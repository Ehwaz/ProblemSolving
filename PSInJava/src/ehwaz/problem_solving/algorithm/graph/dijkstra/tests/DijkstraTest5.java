...
public class DijkstraTest5 {
    ...
    private final String INPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/graph/dijkstra/tests/input05.txt";
    private final String OUTPUT_FILE_PATH = "src/ehwaz/problem_solving/algorithm/graph/dijkstra/tests/output05.txt";
