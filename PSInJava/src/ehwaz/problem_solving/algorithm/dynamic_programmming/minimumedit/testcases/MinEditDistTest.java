package ehwaz.problem_solving.algorithm.dynamic_programmming.minimumedit.testcases;

import ehwaz.problem_solving.algorithm.dynamic_programmming.minimumedit.MinEditDist;
...
public class MinEditDistTest {

    ///////////// Test-specific codes: you only need to modify these lines. /////////////////
    Consumer<InputStream> SOLUTION_TO_TEST = istream -> MinEditDist.solveProb(istream);    // Requires Java 8
    private final int numOfTestCases = 3;
    private final String[] INPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/minimumedit/testcases/input0.txt",
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/minimumedit/testcases/input1.txt",
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/minimumedit/testcases/input2.txt"
    };
    private final String[] OUTPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/minimumedit/testcases/output0.txt",
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/minimumedit/testcases/output1.txt",
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/minimumedit/testcases/output2.txt"
    };
