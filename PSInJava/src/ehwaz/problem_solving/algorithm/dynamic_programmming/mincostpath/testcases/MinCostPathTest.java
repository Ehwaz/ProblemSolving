package ehwaz.problem_solving.algorithm.dynamic_programmming.mincostpath.testcases;

import ehwaz.problem_solving.algorithm.dynamic_programmming.mincostpath.MinCostPath;
...
public class MinCostPathTest {
    ...
    Consumer<InputStream> SOLUTION_TO_TEST = istream -> MinCostPath.runSolution(istream);    // Requires Java 8
    private final int numOfTestCases = 3;
    private final String[] INPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/mincostpath/testcases/input1.txt",
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/mincostpath/testcases/input2.txt",
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/mincostpath/testcases/input3.txt"
    };
    private final String[] OUTPUT_FILE_PATHS = {
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/mincostpath/testcases/output1.txt",
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/mincostpath/testcases/output2.txt",
            "src/ehwaz/problem_solving/algorithm/dynamic_programmming/mincostpath/testcases/output3.txt"
    };
